          ...
          {activeSection === "uploadApply" && (
            <div className="w-full bg-white p-6 shadow-lg rounded-lg">
              <form onSubmit={handleSubmit}>
                {/* CV Upload Field */}
                <p className="mb-2 text-lg text-black">Please upload the required documents, such as your resume or any other relevant materials, consolidated into a single PDF file.</p>
                <div className="mb-4 flex flex-row">
                  <label className="block text-black sm:w-[100%] md:w-[15%] font-semibold">
                ...
                <div className="flex flex-row justify-center mt-6">
                  <button
                    ...
                    className={`py-2 px-4 rounded ${termsAccepted ? "bg-green-500 text-white hover:bg-green-600" : "bg-gray-300 text-gray-500 cursor-not-allowed"}`}
                  >
                    Submit Application
                  </button>
                </div>
